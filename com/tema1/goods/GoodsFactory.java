...
public final class GoodsFactory {
    ...
    public GoodsFactory getInstance() {
        if (instance == null) {
    ...
    public int getKingBonus(final int id) {
        switch (id) {
            case LegalGoodsIds.APPLE:
                return KingBonus.APPLE;
            case LegalGoodsIds.CHEESE:
                return KingBonus.CHEESE;
            case LegalGoodsIds.BREAD:
                return KingBonus.BREAD;
            case LegalGoodsIds.CHICKEN:
                return KingBonus.CHICKEN;
            case LegalGoodsIds.TOMATO:
                return KingBonus.TOMATO;
            case LegalGoodsIds.CORN:
                return KingBonus.CORN;
            case LegalGoodsIds.POTATO:
                return KingBonus.POTATO;
            case LegalGoodsIds.WINE:
                return KingBonus.WINE;
            case LegalGoodsIds.SALT:
                return KingBonus.SALT;
            case LegalGoodsIds.SUGAR:
